...
function PolarisTestProvider({
  ...
  const Wrapper = strict ? React__default.StrictMode : React__default.Fragment;
  ...
  }, /*#__PURE__*/React__default.createElement(FocusManager$1, null, /*#__PURE__*/React__default.createElement(FrameContext.Provider, {
    value: mergedFrame
  }, children)))))))))));
}
