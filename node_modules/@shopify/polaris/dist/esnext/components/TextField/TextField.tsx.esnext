...
function TextField({
  ...
  const clearButtonMarkup = clearButton && normalizedValue !== '' ? /*#__PURE__*/React__default.createElement("button", {
    ...
    disabled: disabled
  }, /*#__PURE__*/React__default.createElement(VisuallyHidden$1, null, i18n.translate('Polaris.Common.clear')), _ref) : null;
  ...
  const spinnerMarkup = type === 'number' && !disabled && !readOnly ? /*#__PURE__*/React__default.createElement(Spinner$1, {
  ...
  const resizer = multiline && isAfterInitial ? /*#__PURE__*/React__default.createElement(Resizer$1, {
  ...
  const input = /*#__PURE__*/React__default.createElement(multiline ? 'textarea' : 'input', {
    name,
    id,
    disabled,
    readOnly,
  ...
  return /*#__PURE__*/React__default.createElement(Labelled$1, {
    label: label,
    id: id,
    error: error,
    action: labelAction,
    ...
    helpText: helpText
  }, /*#__PURE__*/React__default.createElement(Connected$1, {
    left: connectedLeft,
