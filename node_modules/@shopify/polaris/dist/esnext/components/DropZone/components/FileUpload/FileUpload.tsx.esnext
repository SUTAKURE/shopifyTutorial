...
import img from '../../images/file-upload.svg.esnext';
import img$1 from '../../images/image-upload.svg.esnext';
import { DropZoneContext } from '../../context.tsx.esnext';
import styles from './FileUpload.scss.esnext';

var _ref = /*#__PURE__*/React__default.createElement(Stack$1, {
  vertical: true,
  spacing: "tight"
...
function FileUpload(props) {
  ...
  const extraLargeView = size === 'extraLarge' ? /*#__PURE__*/React__default.createElement(Stack$1, {
    vertical: true
    ...
    src: img$1,
    alt: ""
  }), buttonMarkup, /*#__PURE__*/React__default.createElement(TextStyle$1, {
    variation: "subdued"
  }, actionHint)) : null;
  const largeView = size === 'large' ? /*#__PURE__*/React__default.createElement(Stack$1, {
    vertical: true,
    spacing: "tight"
  }, type === 'file' && /*#__PURE__*/React__default.createElement("img", {
    className: imageClasses,
    ...
    src: img$1,
    alt: ""
  }), buttonMarkup, /*#__PURE__*/React__default.createElement(Caption$1, null, /*#__PURE__*/React__default.createElement(TextStyle$1, {
    variation: "subdued"
  }, actionHint))) : null;
  ...
  const mediumView = size === 'medium' ? /*#__PURE__*/React__default.createElement(Stack$1, {
    vertical: true,
    spacing: "tight"
  }, actionTitleMarkup, /*#__PURE__*/React__default.createElement(Caption$1, null, /*#__PURE__*/React__default.createElement(TextStyle$1, {
    variation: "subdued"
  }, actionHint))) : null;
  const smallView = size === 'small' ? _ref : null;
