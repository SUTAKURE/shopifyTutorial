...
function Button({
  ...
  const disclosureIcon = /*#__PURE__*/React__default.createElement(Icon$1, {
  ...
  if (icon) {
    const iconInner = isIconSource(icon) ? /*#__PURE__*/React__default.createElement(Icon$1, {
  ...
  if (connectedDisclosure) {
    ...
    connectedDisclosureMarkup = /*#__PURE__*/React__default.createElement(Popover$1, {
  ...
  if (url) {
    ...
    }, content) : /*#__PURE__*/React__default.createElement(UnstyledLink$1, {
      id: id,
      url: url,
      external: external,
      download: download,
