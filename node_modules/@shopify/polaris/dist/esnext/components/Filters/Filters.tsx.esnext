...
import { TextField as TextField$1 } from '../TextField/TextField.tsx.esnext';
import { ScrollLock as ScrollLock$1 } from '../ScrollLock/ScrollLock.ts.esnext';
import { Collapsible as Collapsible$1 } from '../Collapsible/Collapsible.tsx.esnext';
...
import { Tag as Tag$1 } from '../Tag/Tag.tsx.esnext';
import { Focus as Focus$1 } from '../Focus/Focus.tsx.esnext';
import { Sheet as Sheet$1 } from '../Sheet/Sheet.tsx.esnext';
import { ConnectedFilterControl as ConnectedFilterControl$1 } from './components/ConnectedFilterControl/ConnectedFilterControl.tsx.esnext';
...
var _ref = /*#__PURE__*/React__default.createElement(ScrollLock$1, null);

var _ref2 = /*#__PURE__*/React__default.createElement(Icon$1, {
  source: SearchMinor
});
...
class FiltersInner extends React__default.Component {
  ...
  render() {
    ...
    const backdropMarkup = open ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, _ref, /*#__PURE__*/React__default.createElement("div", {
    ...
    const filtersContentMarkup = filters.map((filter, index) => {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
      ...
      }, /*#__PURE__*/React__default.createElement(TextStyle$1, {
        ...
        source: icon,
        color: "inkLightest"
      }))), appliedFilterBadgeMarkup), /*#__PURE__*/React__default.createElement(Collapsible$1, {
        id: collapsibleID,
        open: filterIsOpen
      }, /*#__PURE__*/React__default.createElement("div", {
        className: styles.FilterNodeContainer
      }, /*#__PURE__*/React__default.createElement(Focus$1, {
    ...
    const filtersControlMarkup = /*#__PURE__*/React__default.createElement(ConnectedFilterControl$1, {
    ...
    }, /*#__PURE__*/React__default.createElement(DisplayText$1, {
      size: "small"
    }, moreFiltersLabel), /*#__PURE__*/React__default.createElement(Button$1, {
    ...
    }, i18n.translate('Polaris.Filters.clearAllFilters')), /*#__PURE__*/React__default.createElement(Button$1, {
      onClick: this.closeFilters,
      primary: true
    }, i18n.translate('Polaris.Filters.done')));
    const filtersMobileFooterMarkup = /*#__PURE__*/React__default.createElement("div", {
      className: styles.FiltersMobileContainerFooter
    }, this.hasAppliedFilters() ? /*#__PURE__*/React__default.createElement(Button$1, {
      onClick: onClearAll,
      fullWidth: true
    ...
    const filtersContainerMarkup = isNavigationCollapsed ? /*#__PURE__*/React__default.createElement(Sheet$1, {
      open: open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      onExit: this.setReadyForFocus(false)
    }, filtersMobileHeaderMarkup, /*#__PURE__*/React__default.createElement(Scrollable$1, {
      className: filtersMobileContainerContentClassName,
      shadow: true
    }, filtersContentMarkup, filtersMobileFooterMarkup)) : /*#__PURE__*/React__default.createElement(Sheet$1, {
      open: open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      onExit: this.setReadyForFocus(false)
    ...
    }, filtersDesktopHeaderMarkup, /*#__PURE__*/React__default.createElement(Scrollable$1, {
    ...
    }, filtersControlMarkup, filtersContainerMarkup, tagsMarkup, helpTextMarkup, backdropMarkup, /*#__PURE__*/React__default.createElement(KeypressListener$1, {
      keyCode: Key.Escape,
  ...
  generateFilterMarkup(filter) {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      vertical: true,
      spacing: "tight"
    }, filter.filter, /*#__PURE__*/React__default.createElement(Button$1, {
      plain: true,
