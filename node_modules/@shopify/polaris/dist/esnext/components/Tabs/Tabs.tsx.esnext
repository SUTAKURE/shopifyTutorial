...
class TabsInner extends React__default.PureComponent {
  ...
  render() {
    ...
    const panelMarkup = children ? tabs.map((_tab, index) => {
      return selected === index ? /*#__PURE__*/React__default.createElement(Panel$1, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id
      }, children) : /*#__PURE__*/React__default.createElement(Panel$1, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id,
        hidden: true
    ...
    })))), /*#__PURE__*/React__default.createElement(TabMeasurer$1, {
