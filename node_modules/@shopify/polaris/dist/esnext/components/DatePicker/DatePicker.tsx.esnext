...
import { isDateBefore, isDateAfter, getNextDisplayYear, getNextDisplayMonth, getPreviousDisplayYear, getPreviousDisplayMonth } from '../../utilities/dates.ts.esnext';
import { monthName } from './utilities.tsx.esnext';
import styles from './DatePicker.scss.esnext';
import { Month as Month$1 } from './components/Month/Month.tsx.esnext';
...
function DatePicker({
  ...
  const secondDatePicker = multiMonth ? /*#__PURE__*/React__default.createElement(Month$1, {
    onFocus: handleFocus,
