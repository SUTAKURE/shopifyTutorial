...
class ActionMenu extends React__default.PureComponent {
    ...
    this.renderActions = () => {
      ...
      const actionMarkup = overriddenActions.map((action, index) => {
        if ('title' in action) {
          ...
          return actions.length > 0 ? /*#__PURE__*/React__default.createElement(MenuGroup$1, Object.assign({
            key: `MenuGroup-${index}`,
            title: title,
        ...
        return newDesignLanguage ? /*#__PURE__*/React__default.createElement(Button$1, Object.assign({
          key: index,
          onClick: onAction
        }, rest), content) : /*#__PURE__*/React__default.createElement(MenuAction$1, Object.assign({
      ...
      }, newDesignLanguage ? /*#__PURE__*/React__default.createElement(ButtonGroup$1, null, actionMarkup) : actionMarkup);
    };
  ...
  render() {
    ...
    }, rollup ? /*#__PURE__*/React__default.createElement(RollupActions$1, {
      items: actions,
