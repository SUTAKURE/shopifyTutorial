...
class DataTableInner extends React__default.PureComponent {
  constructor(...args) {
    ...
    this.renderHeadings = (heading, headingIndex) => {
      ...
      return /*#__PURE__*/React__default.createElement(Cell$1, Object.assign({
        header: true,
        key: id,
        content: heading,
    ...
    this.renderTotals = (total, index) => {
      ...
      return /*#__PURE__*/React__default.createElement(Cell$1, {
        total: true,
  ...
  render() {
    ...
    const navigationMarkup = hideScrollIndicator ? null : /*#__PURE__*/React__default.createElement(Navigation$1, {
