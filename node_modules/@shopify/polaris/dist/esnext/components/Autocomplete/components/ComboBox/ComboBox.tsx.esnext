...
function ComboBox({
  ...
  if (actionsBefore && actionsBefore.length > 0) {
    actionsBeforeMarkup = /*#__PURE__*/React__default.createElement(ActionList$1, {
      actionRole: "option",
  ...
  if (actionsAfter && actionsAfter.length > 0) {
    actionsAfterMarkup = /*#__PURE__*/React__default.createElement(ActionList$1, {
      actionRole: "option",
      items: getActionsWithIds(actionsAfter)
    });
  }

  const optionsMarkup = options.length > 0 && /*#__PURE__*/React__default.createElement(OptionList$1, {
    role: "presentation",
    optionRole: "option",
  ...
  }, /*#__PURE__*/React__default.createElement(Popover$1.Pane, {
