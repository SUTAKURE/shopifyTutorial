...
import React__default, { useRef, useState, useImperativeHandle } from 'react';
...
const Checkbox = /*#__PURE__*/React__default.forwardRef(function Checkbox({
  ...
  return (
    ...
    React__default.createElement(Choice$1, {
      id: id,
      label: label,
