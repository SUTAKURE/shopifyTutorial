...
function Section({
  ...
  const itemsMarkup = items.map(item => {
    ...
    return /*#__PURE__*/React__default.createElement(Item$1, Object.assign({}, rest, {
      key: label,
      label: label,
  ...
  }, /*#__PURE__*/React__default.createElement(Collapsible$1, {
