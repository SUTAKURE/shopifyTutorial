...
import React__default, { useContext, useState, useEffect, useCallback, Fragment } from 'react';
...
import { Indicator as Indicator$1 } from '../../../Indicator/Indicator.tsx.esnext';
import { NavigationContext } from '../../context.tsx.esnext';
import styles from '../../Navigation.scss.esnext';
import { Secondary as Secondary$1 } from './components/Secondary/Secondary.tsx.esnext';
...
var _ref = /*#__PURE__*/React__default.createElement(Indicator$1, {
  pulse: true
});
...
function Item({
  ...
  if (isNew) {
    badgeMarkup = /*#__PURE__*/React__default.createElement(Badge$1, {
      status: "new",
      size: "small"
  ...
  const itemContentMarkup = /*#__PURE__*/React__default.createElement(Fragment, null, iconMarkup, /*#__PURE__*/React__default.createElement("span", {
  ...
  const secondaryActionMarkup = secondaryAction && /*#__PURE__*/React__default.createElement(UnstyledLink$1, {
    external: true,
  ...
  if (subNavigationItems.length > 0 && showExpanded) {
    ...
    secondaryNavigationMarkup = /*#__PURE__*/React__default.createElement("div", {
    ...
    }, /*#__PURE__*/React__default.createElement(Secondary$1, {
      ...
      return /*#__PURE__*/React__default.createElement(Item, Object.assign({}, rest, {
        key: label,
        label: label,
  ...
  }, /*#__PURE__*/React__default.createElement(UnstyledLink$1, {
    url: url,
