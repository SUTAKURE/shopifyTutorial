...
class ColorPicker extends React__default.PureComponent {
  ...
  render() {
    ...
    const alphaSliderMarkup = allowAlpha ? /*#__PURE__*/React__default.createElement(AlphaPicker$1, {
      alpha: alpha,
      color: color,
    ...
    }), /*#__PURE__*/React__default.createElement(Slidable$1, {
      onChange: this.handleDraggerMove,
      draggerX: draggerX,
      draggerY: draggerY
    })), /*#__PURE__*/React__default.createElement(HuePicker$1, {
      hue: hue,
