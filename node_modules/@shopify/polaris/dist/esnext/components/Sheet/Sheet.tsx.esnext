...
function Sheet({
  ...
  return /*#__PURE__*/React__default.createElement(Portal$1, {
    ...
    ref: container
  }), /*#__PURE__*/React__default.createElement(TrapFocus$1, {
    trapping: open
  }, /*#__PURE__*/React__default.createElement("div", {
    role: "dialog",
    tabIndex: -1,
    className: styles.Sheet
  }, children)))), /*#__PURE__*/React__default.createElement(KeypressListener$1, {
    keyCode: Key.Escape,
    handler: onClose
  }), open && /*#__PURE__*/React__default.createElement(Backdrop$1, {
    transparent: true,
    onClick: onClose
  }));
}
