...
class AppProvider extends React__default.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return /*#__PURE__*/React__default.createElement(FeaturesContext.Provider, {
      ...
      theme: theme
    }, /*#__PURE__*/React__default.createElement(MediaQueryProvider$1, null, /*#__PURE__*/React__default.createElement(FocusManager$1, null, children)))))))));
  }
