...
class DualThumb extends React__default.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Labelled$1, {
      id: id,
      label: label,
      error: error,
      action: labelAction,
      ...
      ref: this.thumbUpper,
      disabled: disabled
    }), outputMarkupUpper), suffixMarkup)), /*#__PURE__*/React__default.createElement(EventListener$1, {
      event: "resize",
