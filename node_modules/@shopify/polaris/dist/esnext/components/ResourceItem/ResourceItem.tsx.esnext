...
class BaseResourceItem extends React__default.Component {
  ...
  render() {
    ...
    if (shortcutActions && !loading) {
      if (persistActions) {
        actionsMarkup = /*#__PURE__*/React__default.createElement("div", {
          ...
          onClick: stopPropagation
        }, /*#__PURE__*/React__default.createElement(ButtonGroup$1, null, buttonsFrom(shortcutActions, {
          plain: true
        })));
    ...
    const accessibleMarkup = url ? /*#__PURE__*/React__default.createElement(UnstyledLink$1, {
