import React__default, { useState, useReducer, useRef, useCallback, useEffect } from 'react';
...
const ResourceList = function ResourceList({
  ...
  }, /*#__PURE__*/React__default.createElement(BulkActions$1, {
  ...
  }, /*#__PURE__*/React__default.createElement(CheckableButton$1, {
    accessibilityLabel: bulkActionsAccessibilityLabel(),
    label: headerTitle(),
    onToggleAll: handleToggleAll,
    plain: true,
  ...
  var _ref = /*#__PURE__*/React__default.createElement(EventListener$1, {
    event: "resize",
  ...
  }, /*#__PURE__*/React__default.createElement(Sticky$1, {
  ...
  }, /*#__PURE__*/React__default.createElement(EmptySearchResult$1, Object.assign({}, emptySearchResultText, {
