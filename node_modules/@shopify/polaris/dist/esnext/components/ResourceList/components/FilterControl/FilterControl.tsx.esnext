...
import { FilterCreator as FilterCreator$1 } from './components/FilterCreator/FilterCreator.tsx.esnext';
...
function FilterControl({
  ...
  const handleAddFilter = React__default.useCallback(newFilter => {
    if (!onFiltersChange) {
      return;
    }
  ...
  const handleRemoveFilter = React__default.useCallback(filterId => {
    if (!onFiltersChange) {
      return;
    }
  ...
  const getRemoveFilterCallback = React__default.useCallback(filterId => {
    return () => {
  ...
  const filterCreatorMarkup = filters.length > 0 ? /*#__PURE__*/React__default.createElement(FilterCreator$1, {
  ...
  return /*#__PURE__*/React__default.createElement(FormLayout$1, null, /*#__PURE__*/React__default.createElement(TextField, {
