import React__default, { useContext, useMemo, useEffect, useState, useCallback, useRef, createRef, memo, useLayoutEffect, useImperativeHandle, createContext, Component, Fragment, createElement, useReducer } from 'react';
...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '5.0.0-RC.1';
}
...
var Tokens = _objectSpread2(_objectSpread2(_objectSpread2({}, BorderRadius), Shadow), Overrides);
...
class EventListener extends React__default.PureComponent {
  componentDidMount() {
    this.attachListener();
  }
...
class AppProvider$1 extends React__default.Component {
  constructor(props) {
    super(props);
...
function elementChildren(children, predicate = () => true) {
  return React__default.Children.toArray(children).filter(child => /*#__PURE__*/React__default.isValidElement(child) && predicate(child));
}
...
class Scrollable extends React__default.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      topShadow: false,
...
class PositionedOverlay extends React__default.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      measuring: true,
...
class PopoverOverlay extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
...
class ActionMenu extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
...
class Item$3 extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      focused: false
...
class Banner extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
...
var Checkbox$1 = /*#__PURE__*/React__default.forwardRef(function Checkbox({
...
class CollapsibleInner extends React__default.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
...
class Slidable extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      dragging: false
...
class AlphaPicker extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
...
class HuePicker extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
...
class ColorPicker extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      pickerSize: 0
...
var ContextualSaveBar = /*#__PURE__*/React__default.memo(function ContextualSaveBar({
  message,
  saveAction,
  discardAction,
  alignContentFlush,
...
class DataTableInner extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = /*#__PURE__*/React__default.createRef();
    this.scrollContainer = /*#__PURE__*/React__default.createRef();
    this.table = /*#__PURE__*/React__default.createRef();
    this.handleResize = debounce(() => {
      var {
        table: {
          current: table
...
(function (WeekdayEnum) {
  WeekdayEnum[WeekdayEnum["Sunday"] = 0] = "Sunday";
  WeekdayEnum[WeekdayEnum["Monday"] = 1] = "Monday";
  WeekdayEnum[WeekdayEnum["Tuesday"] = 2] = "Tuesday";
  WeekdayEnum[WeekdayEnum["Wednesday"] = 3] = "Wednesday";
  WeekdayEnum[WeekdayEnum["Thursday"] = 4] = "Thursday";
  WeekdayEnum[WeekdayEnum["Friday"] = 5] = "Friday";
  WeekdayEnum[WeekdayEnum["Saturday"] = 6] = "Saturday";
...
class DropZoneInput extends Component {
  constructor(...args) {
    super(...args);
    this.fileInputNode = /*#__PURE__*/React__default.createRef();
...
class Item$4 extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      focused: false
...
class ConnectedFilterControl extends React__default.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
    ...
    this.container = /*#__PURE__*/React__default.createRef();
    this.proxyButtonContainer = /*#__PURE__*/React__default.createRef();
    this.moreFiltersButtonContainer = /*#__PURE__*/React__default.createRef();
    this.handleResize = debounce(() => {
...
class FiltersInner extends React__default.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      open: false,
...
function Group({
  ...
  var itemsMarkup = React__default.Children.map(children, child => wrapWithComponent(child, Item$5, {}));
  return /*#__PURE__*/React__default.createElement("div", {
    role: "group",
    className: className,
...
class Loading extends React__default.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      progress: 0,
...
var Modal = function Modal({
  ...
  var activatorRef = React__default.useRef(null);
  var i18n = useI18n();
...
class FrameInner extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      skipFocused: false,
    ...
    this.skipToMainContentTargetNode = this.props.skipToContentTarget || /*#__PURE__*/React__default.createRef();
...
class DualThumb extends React__default.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
    ...
    this.track = /*#__PURE__*/React__default.createRef();
    this.trackWrapper = /*#__PURE__*/React__default.createRef();
    this.thumbLower = /*#__PURE__*/React__default.createRef();
    this.thumbUpper = /*#__PURE__*/React__default.createRef();
...
class BaseResourceItem extends React__default.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.buttonOverlay = /*#__PURE__*/React__default.createRef();
...
class StickyInner extends React__default.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      isSticky: false,
...
function CheckableButton({
  ...
  } = React__default.useContext(ResourceListContext);
...
class BulkActionsInner extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
...
function FilterControl({
  ...
  var handleAddFilter = React__default.useCallback(newFilter => {
    if (!onFiltersChange) {
      return;
    }
  ...
  var handleRemoveFilter = React__default.useCallback(filterId => {
    if (!onFiltersChange) {
      return;
    }
  ...
  var getRemoveFilterCallback = React__default.useCallback(filterId => {
    return () => {
...
class Item$8 extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.context = void 0;
...
class TabsInner extends React__default.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      disclosureWidth: 0,
